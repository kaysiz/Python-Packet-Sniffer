...
class DataFlowSet:
    ...
    def __init__(self, data, templates):
        ...
        self.length = pack[1]
        self.actual_template_id = pack[2]
        print("Actual template id:  " + str(self.actual_template_id))
        ...
        template = templates[self.actual_template_id - 2]
    ...
    def __init__(self, data):
        ...
        while offset < self.length:
            ...
            for field in range(field_count):
                ...
                offset += 6
                field_type, field_length, x = struct.unpack('!HHH', data[offset:offset+6])
...
class V9ExportPacket:
    ...
    def __init__(self, data, templates):
        ...
        print("Length of header:  " + str(offset))
